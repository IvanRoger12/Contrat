...
/* ==============================
   i18n (FR / EN)
   -> ajoute une langue en copiant un bloc et en traduisant
============================== */
const I18N = {
  FR: {
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className={`text-2xl font-bold ${dark ? "text-white" : "text-gray-900"}`}>
                  {L.appTitle.slice(0,6)}
                  <span className="text-cyan-400">{L.appTitle.slice(6)}</span>
                </h1>
